...
public class MeasureFactory {
	 ...
	 * of a {@link PullMeasure}. If the value have changed since the last isMet
	 ...
	 * parallel to isMet regularly the {@link Value} modifications. If the
	 ...
	 * @param period
	 *            the number of milliseconds between each isMet
