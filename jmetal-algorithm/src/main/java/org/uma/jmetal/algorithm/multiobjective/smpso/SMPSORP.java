...
public class SMPSORP extends AbstractParticleSwarmOptimization<DoubleSolution, List<DoubleSolution>>
    implements Measurable, InteractiveAlgorithm<DoubleSolution, List<DoubleSolution>> {
  ...
  public void updatePointOfInterest(List<Double> newReferencePoints) {
    ...
    int numberOfPoints= newReferencePoints.size()/problem.getNumberOfObjectives();
    if(numberOfPoints==1){
      ...
      while (i < newReferencePoints.size()) {
        ...
        while (j < problem.getNumberOfObjectives()) {
